...
<template>
    ...
    <div class="sticky top-0 pt-4 bg-cod-gray-50">
      <div class="flex flex-row items-center justify-between">
        ...
        <button 
          ...
          class="flex items-center justify-center gap-1 py-1 pl-1 pr-2 transition-colors duration-100 ease-in-out rounded-sm text-cod-gray-600 hover:text-cod-gray-900 hover:bg-cod-gray-100">
  ...
  <div
    class="absolute top-0 left-0 z-20 flex items-center justify-center w-screen h-screen transition-all duration-100 ease-in-out"
    :class="[ modalOpen ? 'visible opacity-100' : 'invisible opacity-0' ]"
  >
    <div class="absolute top-0 w-full h-full cursor-pointer bg-cod-gray-950 opacity-20"></div>
    <div
      ...
      <form class="flex flex-col gap-4">
        <div class="flex flex-row items-center justify-between">
          ...
          <button 
            ...
            type="button"
            class="flex items-center justify-center gap-2 p-2 transition-colors duration-100 ease-in-out rounded-sm text-cod-gray-600 hover:text-cod-gray-900 hover:bg-cod-gray-100">
