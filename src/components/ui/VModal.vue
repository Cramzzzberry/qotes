...
<template>
  ...
  >
    ...
    <div
      class="z-10 max-h-[calc(100svh-32px)] min-w-[560px] overflow-y-auto rounded-2xl bg-emerald-50 p-6 transition-transform duration-150 ease-in-out on-md:w-full on-md:min-w-0"
